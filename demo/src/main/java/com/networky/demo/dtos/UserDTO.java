...
public class UserDTO {
	...
	public UserDTO(String nome, String cognome, String dataDiNascita, String country, byte[] image) {
		this.nome = nome;
	...
	public UserDTO(String nome, String newNome, String cognome, String newCognome, String dataDiNascita,
			String newDataDiNascita, String country, String newCountry, byte[] image) {
		super();
		this.nome = nome;
	...
	public String toString() {
		return "UserDTO [id=" + id + ", nome=" + nome + ", newNome=" + newNome + ", cognome=" + cognome
				...
				+ newDataDiNascita + ", country=" + country + ", newCountry=" + newCountry + ", image="
